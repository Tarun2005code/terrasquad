    ...
    >
      ...
      <div className="relative z-10 max-w-7xl px-4 sm:px-6 text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
          <Link
            href={isLoggedIn ? "/expeditions" : "/signup"}
            className="bg-[#2F5D50] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold text-center transition-all duration-200 hover:scale-105 active:scale-95 active:bg-[#23463B]"
          >
            {isLoggedIn
              ? "Join Expedition"
              : "Sign Up to Join Expeditions"}
          </Link>

          <Link
            href="/#featured-expeditions"
            scroll
            className="border border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold text-center transition-all duration-200 hover:bg-white hover:text-black"
          >
            View Expeditions
          </Link>
        </div>
